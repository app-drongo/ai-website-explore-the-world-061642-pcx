...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Discover extraordinary destinations and create unforgettable memories with our curated travel experiences. Join thousands of adventurers who trust us to make their dream journeys come true.',
  contactEmail: 'hello@exploretheworld.com',
  contactPhone: '+1 (555) 987-6543',
  contactAddress: '456 Adventure Blvd, Suite 200',
  ...
  section4Title: 'Legal',
  copyrightText: '© 2024 Explore the World. All rights reserved.',
  madeWithText: 'by travel enthusiasts',
  socialText: 'Follow our journey:',
  social1Href: 'https://twitter.com/exploretheworld',
  social2Href: 'https://facebook.com/exploretheworld',
  social3Href: 'https://instagram.com/exploretheworld',
  social4Href: 'https://linkedin.com/company/exploretheworld',
  social5Href: 'https://github.com/exploretheworld',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Europe Tours', href: '/europe', editableId: 'link-footer-europe' },
        { name: 'Asia Adventures', href: '/asia', editableId: 'link-footer-asia' },
        { name: 'African Safaris', href: '/africa', editableId: 'link-footer-africa' },
        { name: 'South America', href: '/south-america', editableId: 'link-footer-south-america' },
        { name: 'Cruise Packages', href: '/cruises', editableId: 'link-footer-cruises' },
        { name: 'Custom Trips', href: '/custom', editableId: 'link-footer-custom' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        { name: 'Travel Guides', href: '/guides', editableId: 'link-footer-guides' },
        { name: 'Trip Planning', href: '/planning', editableId: 'link-footer-planning' },
        { name: 'Travel Tips', href: '/tips', editableId: 'link-footer-tips' },
        { name: 'Visa Information', href: '/visa', editableId: 'link-footer-visa' },
        { name: 'Travel Insurance', href: '/insurance', editableId: 'link-footer-insurance' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Booking Terms', href: '/booking-terms', editableId: 'link-footer-booking-terms' },
        {
          name: 'Cancellation Policy',
          href: '/cancellation',
          editableId: 'link-footer-cancellation',
        },
        { name: 'Travel Safety', href: '/safety', editableId: 'link-footer-safety' },
  ...
  const bottomLinks = [
    { name: 'Site Map', href: '/sitemap', editableId: 'link-footer-sitemap' },
    {
      ...
      href: '/travel-accessibility',
      editableId: 'link-footer-travel-accessibility',
    },
    { name: 'Cookie Preferences', href: '/cookies', editableId: 'link-footer-cookie-settings' },
    { name: '24/7 Support', href: '/support', editableId: 'link-footer-24-support' },
  ];
