...
const DEFAULT_HERO = {
  badge: 'New: Exclusive 2024 Tours',
  title: 'Discover breathtaking destinations with',
  titleHighlight: 'Explore the World',
  description:
    'Experience the magic of France, Morocco, Spain, and Egypt with our expertly crafted tours. From the romantic streets of Paris to the ancient pyramids of Giza.',
  features: [
    'Expert local guides',
  ...
  secondaryCTA: 'Watch Tours',
  primaryCTAHref: '#contact',
  secondaryCTAHref: '#demo',
  imageUrl:
    'https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Beautiful travel destinations',
  statsLabel1: 'Happy Travelers',
  statsValue1: '15,000+',
  statsLabel2: 'Destinations',
  statsValue2: '4 Countries',
} as const;
...
export default function Hero(props: HeroProps) {
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-background">
      <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-transparent to-yellow-500/15" />
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          <div className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-red-500/20 bg-red-500/10 px-3 py-1.5 text-sm font-medium text-red-600">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span
                className="block bg-gradient-to-r from-red-600 to-yellow-600 bg-clip-text text-transparent"
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base border-yellow-500 text-yellow-600 hover:bg-yellow-50"
          ...
          <div className="relative">
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold text-red-600" data-editable="statsValue1">
                  {config.statsValue1}
                </span>
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold text-yellow-600" data-editable="statsValue2">
                  {config.statsValue2}
                </span>
              </p>
            </div>
